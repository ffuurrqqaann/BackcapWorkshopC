...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='This table contains the answers to the questions';
...
INSERT INTO `answers` (`id`, `question_id`, `option_id`, `device_id`) VALUES
	(1, 1, 1, '12334566'),
	(2, 1, 5, '25364-24371-29669-18092'),
	(3, 2, 3, '25364-24371-29669-18092');
...
CREATE TABLE IF NOT EXISTS `options` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='This table contains the options to the questions.';

-- Dumping data for table backcap.options: ~5 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `study` (
  ...
  `name` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=latin1 COMMENT='This table contains all the study';
